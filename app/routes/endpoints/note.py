        ...
        if validate(request.params, MODELS['manager_notes_create']):
            ...
            if user.id:
                ...
                if request.user.check_roles({ 'admin', 'editor', 'manager', 'chief' }) or \
                        ...
                        (user.agent_id == request.user.id or (user.curators and request.user.id in user.curators)):
                    ...
                    if (user.agent_id == request.user.id or (user.curators and request.user.id in user.curators)):
